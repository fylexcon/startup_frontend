      ...
      <div>
        <HashRouter>
          ...
          <Routes>
            ...
            {/* Product routes - Public but could be protected */}
            ...
            {/* Project routes - Public but could be protected */}
            ...
            {/* Catch all - redirect to dashboard if authenticated, otherwise to products */}
